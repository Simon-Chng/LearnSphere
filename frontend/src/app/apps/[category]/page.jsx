...
/**
 * Component for displaying a feature page based on the category.
 *
 * @component
 * @param {Object} props - Component props
 * @param {Object} props.params - Route parameters passed from Next.js
 * @param {string} props.params.category - The category slug used to determine content
 * @returns {JSX.Element} The rendered category content or a not-found message
 */
