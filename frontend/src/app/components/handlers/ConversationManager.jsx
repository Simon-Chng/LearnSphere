...
/**
 * ConversationManager handles conversation deletion and clearing logic
 * for both guest and logged-in users. It provides modals for confirming
 * deletion actions and injects management callbacks into its children.
 *
 * @component
 * @param {Object} props
 * @param {Array} props.conversations - List of conversation objects.
 * @param {Function} props.setConversations - Setter to update the conversation list.
 * @param {string|number|null} props.currentConversationId - Currently active conversation ID.
 * @param {Function} props.setCurrentConversationId - Setter to update the active conversation ID.
 * @param {boolean} props.isGuest - Indicates whether the user is in guest mode.
 * @param {React.ReactNode} props.children - Child components receiving injected props.
 * @returns {JSX.Element}
 */
