...
/**
 * ChatPage displays the interactive chat interface for a specific conversation.
 * It loads chat data based on the conversation ID, handles guest and logged-in modes,
 * manages conversation titles, and provides a complete chat UI.
 *
 * @component
 * @returns {JSX.Element} The full chat interface with sidebar, modal, history, and input.
 */
export default function ChatPage() {
  ...
  /**
   * Handles saving an edited conversation title locally and to the backend (if not in guest mode).
   */
  ...
  /**
   * Handles sidebar conversation selection, including conditional routing logic for guest vs logged-in mode.
   * @param {string} id - ID of the selected conversation
   */
  ...
  /**
   * Handles creation of a new chat, including logic for guest and logged-in users.
   *
   * @param {string} model - Selected model ID
   * @param {string|number} category - Selected category ID
   */
